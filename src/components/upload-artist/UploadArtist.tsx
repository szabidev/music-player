...
const UploadArtist = ({ onClose }: { onClose: (event: any) => void }) => {
  ...
  const handleSubmit = (event: React.FormEvent) => {
    ...
    // Here you can add code to send `newArtist` to the database
  };
          ...
          <form onSubmit={handleSubmit}>
            <div className="w-full">
              ...
              {songs.map((song, index) => (
                <SongInput
                  key={song.title + index.toString()}
                  index={index}
                  song={song}
                  handleDynamicInputValueChange={handleDynamicInputValueChange}
